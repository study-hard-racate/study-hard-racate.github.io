...
PAGES = {
    ...
    "/doubly-linked-list": "doubly-linked-list/index.html",
...
ALGO_PAGES = [p for p in PAGES if p not in ("/", "/sorting", "/search", "/data-structure", "/tree-graph", "/dp", "/classic", "/learning-path", "/compare")]
